...
LOCAL_PATH := device/smart/sprint4g

# inherit from the proprietary version
-include vendor/smart/sprint4g/BoardConfigVendor.mk
...
TARGET_PREBUILT_KERNEL := device/smart/sprint4g/prebuilt/kernel

#system.prop
TARGET_SYSTEM_PROP := device/smart/sprint4g/system.prop

# CMHW
#BOARD_HARDWARE_CLASS := device/smart/sprint4g/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/smart/sprint4g/bluetooth
...
#recovery
TARGET_RECOVERY_FSTAB := device/smart/sprint4g/recovery/root/etc/twrp.fstab
...
BOARD_EGL_CFG := device/smart/sprint4g/configs/egl.cfg
...
# SELinux
BOARD_SEPOLICY_DIRS := \
       device/smart/sprint4g/sepolicy
