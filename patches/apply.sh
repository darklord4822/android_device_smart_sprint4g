...
cd ../..
cd frameworks/base
git apply -v ../../device/smart/sprint4g/patches/frameworks_base/0001-location-support-GNSS-extension-presumably-from-MTK.patch
...
git apply -v ../../../device/smart/sprint4g/patches/frameworks_opt_telephony/0002_mobile_data_patch_mt6753.patch
cd ../../..
